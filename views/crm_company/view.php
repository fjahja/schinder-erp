...
<div class="wrapper">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header with-border lh-34" style="height:57px;">
              <div class="pull-left">
                <h4>Contacts related to this company:</h4>
              </div>
  ...
  <aside class="control-sidebar control-sidebar-light control-sidebar-open h100 pl-sm pr-sm hidden-print">
    ...
    <div class="side-item pt-sm posrel">
      <code style="padding-left:0;">CRM Company</code>
      <div class="clear"></div>
      <br>
    ...
    <!-- side item -->
    <div class="side-item pt-sm posrel">
      <h3 class="sm m-none">Address:</h3>
      <br>
      <span class="c-lightgrey">
        <?php echo (empty($model['address']) ? 'No address for this company' : $model['address']); ?>
      </span>
      <div class="clear"></div>
      <br>
    </div>
    ...
    <div class="side-item pt-sm posrel">
      ...
      <br>
      <span class="c-lightgrey">
        <?php echo (empty($model['notes']) ? 'No notes for this company' : $model['notes']); ?>
      </span>
      <div class="clear"></div>
      <br>
    </div>
