          ...
          <div class="box">
            ...
            <div class="box-header pb-xs pt-sm with-border">
                ...
                <div class="btn-group">
                  <?php if (!$_GET['search']): ?>
                    <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      Search Company <span class="caret"></span>
                    </button>
                  <?php else: ?>
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="#" data-toggle="modal" data-target="#crmaccSearchByName"><i class="fa fa-search"></i>Search by name</a></li>
                    <?php if ($_GET['search']): ?>
                ...
                <div class="pull-right" style="margin-bottom:15px;">
                  ...
                  <?php if ($_GET['trash'] == 0): ?>
                    <a href="?o=crm_company&v=admin&trash=1" class="btn btn-default" data-toggle="tooltip" data-placement="top" data-original-title="View all records in trash bin"><i class="glyphicon glyphicon-trash"></i> Trash bin</a>
                  <?php endif ?>

                  <?php if ($_GET['trash'] == 1): ?>
                    <a href="?o=crm_company&v=admin" class="btn btn-default" data-toggle="tooltip" data-placement="top" data-original-title="View all active records"><i class="glyphicon glyphicon-saved"></i> Back to active records</a>
                  ...
                  <?php if (hasPermission($admin,array(432))): ?>
