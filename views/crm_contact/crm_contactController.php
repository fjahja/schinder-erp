...
$page['parent'] = 'CRM Contact';
$page['model'] = 'crm_contact';
...
switch($_GET["v"]){
	...
	case "admin":
		...
		// begin fetching data
		$output = getCrmContactAdmin($_GET,$admin);
	...
	case "view":
		...
		$page['title'] = 'CR'.$_GET['id'];

		// begin fetching data
		$model = getRowRedirectError('tbl_crm_contact',$_GET['id']);
		$companies = getCompaniesInContact($model);
