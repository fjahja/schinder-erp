            ...
            <div class="box-body pb-xs pt-sm">
              ...
              <div class="row">
                <div class="col-xs-8">
                  ...
                  <form class="form-horizontal" action="crud/agreement.php?v=update" method="post">
                    <input type="hidden" name="Form[id]" value="<?php echo $model['id']; ?>">
                    <input type="hidden" name="Form[return]" value="index.php?o=agreement&v=view&id=<?php echo $model['id']; ?>&alert=updated">
