            ...
            <div class="box-body pb-xs">
              ...
              <div class="row">
                <div class="col-xs-8">
                  ...
                  <form class="form-horizontal" action="crud/<?php echo $page['model']; ?>.php?v=update_users" method="post">

                    <input type="hidden" name="Form[id]" value="<?php echo $model['id']; ?>">
                    <input type="hidden" name="Form[return]" value="index.php?o=<?php echo $page['model']; ?>&v=users&id=<?php echo $model['id']; ?>&alert=updated">
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-12">
                          <select class="form-control select2 assignto-select" name="Form[assigned_to][]" multiple="multiple" data-placeholder="Select users">
