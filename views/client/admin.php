            ...
            <div class="box-header pb-xs pt-sm with-border">
                ...
                <div class="form-group inline-block">
                    <select class="form-control" onchange="location = this.value;">
                      <option <?php echo ($_GET['trash'] == '0' ? 'selected' : ''); ?> value="?<?php echo removeUrl($currentUrl,'trash'); ?>&trash=0">Active Clients (<?php echo $output['not_trash']; ?>)</option>
                ...
                <div class="pull-right" style="margin-bottom:15px;">
                  <a href="?o=<?php echo $page['model']; ?>&v=create" class="btn btn-success">New Client</a>
                </div>
