            ...
            <div class="box-body pb-xs pt-sm">
              ...
              <div class="row">
                <div class="col-xs-8">
                  ...
                  <form class="form-horizontal" action="crud/contribution.php?v=update" method="post">
                    <input type="hidden" name="Form[id]" value="<?php echo $model['id']; ?>">
                    <input type="hidden" name="Form[return]" value="index.php?o=ticket&v=view&id=<?php echo $ticket['id']; ?>&alert=updated&tab=contributions">
